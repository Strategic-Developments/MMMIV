    ...
    partial class Parts {
        ...
        WeaponDefinition Weapon75 => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    RotateRate = FAST_ROTATE_SPEED, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = FAST_ROTATE_SPEED, // Max traversal speed of elevation subpart in radians per tick.
