...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AmunRaPrimaryRound => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "AmunRaAmmoMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "AP", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            BackKickForce = 75000f, // Recoil. This is applied to the Parent Grid.
            ...
            EnergyMagazineSize = 19, // For energy weapons, how many shots to fire before reloading.
            ...
            {
                AmmoRound = "CustosDiscardedSabot", // AmmoRound field of the ammo to spawn.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ByBlockHit = new ByBlockHitDef
                {
                    ...
                    Radius = 12.5f, // Meters
                    Damage = 2100f,
                    Depth = 12.5f, // Max depth of AOE effect, in meters. 0=disabled, and AOE effect will reach to a depth of the radius value
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 950f, //
                        Width = 0.1f, //
                        Color = Color(red: 15, green: 15, blue: 25, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 120, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "ProjectileTrailLine", // Please always have this Line set, if this Section is enabled. WeaponLaser ProjectileTrailLine
                        },
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            Color = Color(red: 25, green: 25, blue: 0f, alpha: 1),
                            WidthMultiplier = 1f,
                            Reverse = false, 
            ...
            Ejection = new EjectionDef // Optional Component, allows generation of Particle or Item (Typically magazine), on firing, to simulate Tank shell ejection
            {
                ...
                Speed = 5f, // Speed inventory is ejected from in dummy direction
                SpawnChance = 1.0f, // chance of triggering effect (0 - 1)
                CompDef = new ComponentDef
                {
                    ItemName = "", //InventoryComponent name
                    ItemLifeTime = 120, // how long item should exist in world
