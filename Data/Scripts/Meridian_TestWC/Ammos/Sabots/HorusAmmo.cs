...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef HorusPrimaryRound => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "HorusAmmoMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
