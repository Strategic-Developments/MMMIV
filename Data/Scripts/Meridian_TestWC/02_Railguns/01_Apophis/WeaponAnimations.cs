...
{ // Don't edit above this line
    partial class Parts
    {
        private AnimationDef mss_lg_t_apophis_anim => new AnimationDef
        {
            ...
            EventParticles = new Dictionary<PartAnimationSetDef.EventTriggers, EventParticle[]>
            {
                [PreFire] = new[]{ //This particle fires in the Prefire state, during the 10 second windup the gauss cannon has.
                       ...
                       new EventParticle
                       {
                           EmptyNames = Names("MuzzleFlash"), //If you want an effect on your own dummy
                           MuzzleNames = Names("MuzzleFlash"), //If you want an effect on the muzzle
