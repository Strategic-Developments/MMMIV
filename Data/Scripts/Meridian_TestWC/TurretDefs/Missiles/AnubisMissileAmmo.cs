...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef AnubisAmmo => new AmmoDef
        {
            AmmoMagazine = "AnubisAmmoMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Anubis Missile", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            ...
            {
                ModelName = "\\Models\\Cubes\\large\\MissileSubpart.mwm",
        ...
        private AmmoDef AnubisArmoredMissile => new AmmoDef
        {
            AmmoMagazine = "AnubisAmmoMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Armored-Anubis Missile", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 10f, // Direct damage; one steel plate is worth 100.
