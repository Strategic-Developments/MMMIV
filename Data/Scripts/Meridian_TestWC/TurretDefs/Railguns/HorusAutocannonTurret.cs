...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition LG_HeavyAutocannonTurret => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MerDMK1Base",
                        SpinPartId = "None",
                        MuzzlePartId = "elev",
                        AzimuthPartId = "azim",
                        ElevationPartId = "elev",
                        DurabilityMod = 0.2f,
                    }
                },
                Muzzles = new [] {
            ...
            {
                PartName = "Horus-Pattern Autocannon", // name of weapon in terminal
                ...
                Audio = new HardPointAudioDef {
                    PreFiringSound = "",
                    FiringSound = "shell_out_med_02", // WepShipGatlingShot
                ...
                Graphics = new HardPointParticleDef {
                    ...
                    Effect1 = new ParticleDef {
                        Name = "AutocannonBlast", // Smoke_LargeGunShot
