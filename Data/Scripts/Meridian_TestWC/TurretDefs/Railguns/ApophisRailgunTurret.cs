...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition ApophisRailgun => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CustosBase",
                        SpinPartId = "None",
            ...
            {
                PartName = "Apophis-Pattern Railgun", // name of weapon in terminal
                ...
                Audio = new HardPointAudioDef {
                    ...
                    FiringSound = "MERD_RailgunCharge", // WepShipGatlingShot
                ...
                Graphics = new HardPointParticleDef {
                    ...
                    Effect1 = new ParticleDef {
                        Name = "Monarch_Muzzle_Flash_T", // Smoke_LargeGunShot
