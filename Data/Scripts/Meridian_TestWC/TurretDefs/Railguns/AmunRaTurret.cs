...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition LG_SuperRailgunTurret => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AmunRaBase",
                        SpinPartId = "None",
            ...
            {
                PartName = "Amun-Ra Heavy Railgun Turret", // name of weapon in terminal
                DeviateShotAngle = 0,
                ...
                Audio = new HardPointAudioDef {
                    ...
                    FiringSound = "MERD_RailgunShotLarge", // WepShipGatlingShot
                    FiringSoundPerShot = true,
                    ReloadSound = "",
                    NoAmmoSound = "",
                    HardPointRotationSound = "MERD_Whistle",
                    BarrelRotationSound = "",
                ...
                Graphics = new HardPointParticleDef {
                    ...
                    {
                        Name = "Monarch_Muzzle_Flash_T2",//Muzzle_Flash_Large
