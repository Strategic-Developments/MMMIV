        ...
        WeaponDefinition mss_lg_t_amunra => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 670 * 4.01f / 1000f, // Inventory capacity in kL.
                ...
                {
                    RateOfFire = 8, // Set this to 3600 for beam weapons. This is how fast your gun fires per minute.
                    BarrelsPerShot = 1, // How many muzzles will fire a projectile per fire event.
                    TrajectilesPerBarrel = 1, // Number of projectiles per muzzle per fire event.
                    SkipBarrels = 0, // Number of muzzles to skip after each fire event.
                    ReloadTime = 8 * 60, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "heavyrailgunsfx", // Audio for firing.
