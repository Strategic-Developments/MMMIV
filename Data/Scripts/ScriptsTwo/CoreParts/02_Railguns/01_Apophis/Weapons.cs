...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition mss_lg_t_apophis => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "mss_lg_t_apophis_base", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Apophis-Pattern Railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 140 * 6.01f / 1000f, // Inventory capacity in kL.
                    ...
                    IdlePower = 220, // Constant base power draw in MW.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 1 * 60, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    ...
                    HeatPerShot = 600000, // Heat generated per shot (BarrelsPerShot * HeatPerShot is the total heat per firing event).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "MERD_RailgunShot", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Monarch_Muzzle_Flash_T", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                mss_lg_t_apophis_ammo,
                mss_lg_t_apophis_ammo_special,
                mss_lg_t_apophis_ammo_special_shrapnel
            },
            Animations = mss_lg_t_apophis_anim,
