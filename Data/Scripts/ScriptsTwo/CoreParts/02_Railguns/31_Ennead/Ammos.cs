...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef mss_lg_f_ennead_ammo_special => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoRound = "mss_lg_f_ennead_ammo_special", // Unique name used in server overrides and in the terminal (default).  Should be different for each ammoDef used by the same weapon.  Referred to for Shrapnel.
