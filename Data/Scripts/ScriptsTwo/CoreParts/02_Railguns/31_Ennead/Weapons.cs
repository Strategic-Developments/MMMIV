...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition mss_lg_f_ennead => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "mss_lg_f_ennead", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Ennead Railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 2010 * 2.01f / 1000f, // Inventory capacity in kL.
                ...
                {
                    RateOfFire = 5, // Set this to 3600 for beam weapons. This is how fast your gun fires per minute.
                    BarrelsPerShot = 1, // How many muzzles will fire a projectile per fire event.
                    TrajectilesPerBarrel = 1, // Number of projectiles per muzzle per fire event.
                    SkipBarrels = 0, // Number of muzzles to skip after each fire event.
                    ReloadTime = 12 * 60 + 30, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
