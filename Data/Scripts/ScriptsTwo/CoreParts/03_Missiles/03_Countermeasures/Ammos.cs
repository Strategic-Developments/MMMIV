...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef mss_lg_f_scarab_ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "mss_lg_f_scarab_ammomagazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "mss_lg_f_scarab_ammo", // Unique name used in server overrides and in the terminal (default).  Should be different for each ammoDef used by the same weapon.  Referred to for Shrapnel.
            ...
            {
                AmmoRound = "mss_lg_f_scarab_ammo_stage2", // AmmoRound field of the ammo to spawn.
