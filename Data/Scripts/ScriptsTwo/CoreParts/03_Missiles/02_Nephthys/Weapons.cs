...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition mss_lg_f_nepthys => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "mss_lg_f_nepthys", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Nepthys Torpedo Tube", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                DelayCeaseFire = 5 * 60, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released - while a target is available.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 1120 * 2.01f / 1000f, // Inventory capacity in kL.
                ...
                Loading = new LoadingDef
                {
                    ...
                    DelayUntilFire = 4 * 60, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            Ammos = new[] {
                mss_lg_f_nepthys_ammo,

            },
            Animations = mss_lg_f_nepthys_anim,
