...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef mss_lg_f_nepthys_ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "mss_lg_f_nepthys_ammomagazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "mss_lg_f_nepthys_ammo", // Unique name used in server overrides and in the terminal (default).  Should be different for each ammoDef used by the same weapon.  Referred to for Shrapnel.
            ...
            Mass = 675, // Disabled here. Too lazy to set this to 0 everywhere so MasterConfig does it
            Health = 40f, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            ...
            AreaOfDamage = new AreaOfDamageDef // Note AOE is only applied to the Player/Grid it hit (and nearby projectiles) not nearby grids/players.
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1,
                    CustomParticle = "Meridian_TorpedoImpact", // Particle SubtypeID, from your Particle SBC
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                DesiredSpeed = (MISSILE_VELOCITY + MISSILE_START_VELOCITY) * 0.5f, // voxel phasing if you go above 5100
