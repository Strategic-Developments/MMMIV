...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition mss_lg_f_jackal => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "mss_lg_f_jackal", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Jackal Missile Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 310 * 24.05f / 1000f, // Inventory capacity in kL.
