...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition mss_lg_f_anubis => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "mss_lg_f_anubis", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Targeting = new TargetingDef
            {
                ...
                TopTargets = 15, // Number of potential grid targets to randomize, then go in list order ; 0 = no randomization, goes in order of SortedThreats list
            ...
            {
                PartName = "Anubis Missile Tube", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                DelayCeaseFire = 4 * 60, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released - while a target is available.
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 840 * 3.01f / 1000f, // Inventory capacity in kL.
                    ...
                    CriticalReaction = new CriticalDef
                    {
                        ...
                        AmmoRound = "", // Optional. If specified, the warhead will always use this ammo on detonation rather than the first hardpoint usable ammo type.  
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 20 * 60, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 1, // Number of physical magazines to consume on reload.
                    DelayUntilFire = 3 * 60, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    HeatPerShot = 1500000, // Heat generated per shot (BarrelsPerShot * HeatPerShot is the total heat per firing event).
                    MaxHeat = 1400000, // Max heat before weapon enters cooldown (70% of max heat).
                    ...
                    InventoryFillAmount = INV_FILL_AMOUNT, // 0.00-1.00f as a % of inventory volume that a weapon will try to fill up to when requesting magazines from the conveyor system (0.75f = 75%)
                    InventoryLowAmount = INV_LOW_AMOUNT, // 0.00-1.00f as a % of inventory volume.  If the current inventory is below this value, ammo magazines will be requested from the conveyor system (0.25f = 25%)
