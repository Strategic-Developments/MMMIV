...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition mss_lg_t_crook => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "mss_lg_t_crook_base", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            HardPoint = new HardPointDef
            {
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 490 * 4.01f / 1000f, // Inventory capacity in kL.
                ...
                {
                    RateOfFire = 480, // Set this to 3600 for beam weapons. This is how fast your gun fires per minute.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "shell_out_small_03", // Audio for firing.
