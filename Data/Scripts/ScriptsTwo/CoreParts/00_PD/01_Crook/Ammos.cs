...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef mss_lg_t_crook_ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "mss_lg_t_crook_ammomagazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "mss_lg_t_crook_ammo", // Unique name used in server overrides and in the terminal (default).  Should be different for each ammoDef used by the same weapon.  Referred to for Shrapnel.
            TerminalName = "Flak", // Optional terminal name for this ammo type, used when picking ammo/cycling consumables.  Safe to have duplicates across different ammo defs.
            ...
            BackKickForce = 30f * PD_VELOCITY, // Recoil. This is applied to the Parent Grid.
            ...
            Shape = new ShapeDef // Defines the collision shape of the projectile, defaults to LineShape and uses the visual Line Length if set to 0.
            {
                ...
                Diameter = 250, // For SphereShape this is diameter.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 0.001f, // How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = CLOSE_RANGE, // Max Distance the projectile or beam can Travel.
        ...
        private AmmoDef mss_lg_t_crook_ammo_expl => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "mss_lg_t_crook_ammo_expl", // Unique name used in server overrides and in the terminal (default).  Should be different for each ammoDef used by the same weapon.  Referred to for Shrapnel.
            TerminalName = "Proximity Fuse", // Optional terminal name for this ammo type, used when picking ammo/cycling consumables.  Safe to have duplicates across different ammo defs.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 1f, // Modified in MasterConfig here, actually just the power requirement needed to fire at 1.0 ROF scalar
            ...
            {
                Shape = LineShape, // LineShape or SphereShape. Do not use SphereShape for fast moving projectiles if you care about precision.
                Diameter = 15, // For SphereShape this is diameter.
                               // For LineShape it is total length (double this value when setting up MaximumDiameter for weapon targeting).
                               // Defaults to 1 if left zero or deleted.
            },
            ObjectsHit = new ObjectsHitDef
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 4, // Max Distance the projectile or beam can Travel.
                DeaccelTime = 0, // EWAR & Mines only- time to spend slowing down to stop at end of trajectory.  0 is instant stop
                GravityMultiplier = 1f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
                RangeVariance = Random(start: 0, end: 0), // subtracts value from MaxTrajectory
        ...
        private AmmoDef mss_lg_t_crook_ammo_shrapnel_spawner => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "mss_lg_t_crook_ammo_shrapnel_spawner", // Unique name used in server overrides and in the terminal (default).  Should be different for each ammoDef used by the same weapon.  Referred to for Shrapnel.
            TerminalName = "Proximity Fuse", // Optional terminal name for this ammo type, used when picking ammo/cycling consumables.  Safe to have duplicates across different ammo defs.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 1f, // Modified in MasterConfig here, actually just the power requirement needed to fire at 1.0 ROF scalar
            BaseDamage = 10f, // Direct damage; one steel plate is worth 100.
            ...
            AreaOfDamage = new AreaOfDamageDef // Note AOE is only applied to the Player/Grid it hit (and nearby projectiles) not nearby grids/players.
            {
                ...
                {
                    Enable = false,
                    Radius = 250f, // Radius of AOE effect, in meters.
                    Damage = 1f,
                    Depth = 1f, // Max depth of AOE effect, in meters. 0=disabled, and AOE effect will reach to a depth of the radius value
                    MaxAbsorb = 0f, // Soft cutoff for damage (total, against shields or grids), except for pooled falloff.  If pooled falloff, limits max damage per block.
                    Falloff = Pooled, //.NoFalloff applies the same damage to all blocks in radius
                    ...
                    CustomParticle = "Explosion_Missile", // Particle SubtypeID, from your Particle SBC
                                                          // If you need to set a custom offset, specify it in the "Hit" particle
                    CustomSound = "Explosion_MediumCaliberShell", // SubtypeID from your Audio SBC, not a filename
                    Shape = Round, // Round or Diamond shape.  Diamond is more performance friendly.
                },
            },
            Ewar = new EwarDef
        ...
        private AmmoDef mss_lg_t_crook_ammo_shrapnel => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "mss_lg_t_crook_ammo_shrapnel", // Unique name used in server overrides and in the terminal (default).  Should be different for each ammoDef used by the same weapon.  Referred to for Shrapnel.
            ...
            {
                Shape = LineShape, // LineShape or SphereShape. Do not use SphereShape for fast moving projectiles if you care about precision.
                Diameter = 5, // For SphereShape this is diameter.
                              // For LineShape it is total length (double this value when setting up MaximumDiameter for weapon targeting).
                              // Defaults to 1 if left zero or deleted.
            },
            ObjectsHit = new ObjectsHitDef
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Grids = new GridSizeDef //If both of these values are -1, a 4x buff to SG weapons firing at LG and 0.25x debuff to LG weapons firing at SG will apply
                {
                    Large = 0.0625f, // Multiplier for damage against large grids.
                    Small = 1f, // Multiplier for damage against small grids.
                },
                Armor = new ArmorDef
                {
                    Armor = 0.025f, // Multiplier for damage against all armor. This is multiplied with the specific armor type multiplier (light, heavy).
                    Light = 1f, // Multiplier for damage against light armor.
                    Heavy = 0.5f, // Multiplier for damage against heavy armor.
                    NonArmor = 0.025f, // Multiplier for damage against every else.
                },
                Shields = new ShieldDef
                {
                    Modifier = 5f, // Multiplier for damage against shields.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 900, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
                AccelPerSec = 0f, // Acceleration in Meters Per Second. Projectile starts on tick 0 at its parents (weapon/other projectiles) travel velocity.
                DesiredSpeed = 500 * 4, // voxel phasing if you go above 5100
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 0f, //
                        Width = 0f, //
                        Color = Color(red: 6, green: 4, blue: 3, alpha: 2) * 0.5f, // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 3, green: 1.3f, blue: 1, alpha: 1),
                        Back = false,
                        CustomWidth = 0.05f,
            ...
            {
                TravelSound = "", // SubtypeID for your Sound File. Travel is sound generated around your projectile in flight
                HitSound = "ImpMetalMetalCat0", // Default hit sound, used unless optional hit sounds below are populated.  MUST HAVE A VALUE FOR ANY HIT SOUND TO WORK! 
                ShotSound = "", // Sound when fired
                ShieldHitSound = "ImpMetalMetalCat0", // Shield hit
                PlayerHitSound = "ImpMetalMetalCat0", // Player character hit
                VoxelHitSound = "ImpMetalRockCat0", // Voxel hit
                FloatingHitSound = "ImpMetalRockCat0", // Floating object hit (IE components floating in space)
                WaterHitSound = "ImpMetalRockCat0", // Water hit sound, if Water Mod is present
                HitPlayChance = 0.5f, //0-1% chance for any hit sound to play
                HitPlayShield = true, //Including chance above, determines if the ShieldHitSound (or if ShieldHitSound is blank, default HitSound) will play for shield hits
            },
        };

        private AmmoDef mss_lg_t_crook_ammo_special => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "mss_lg_t_crook_ammomagazine_special", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "mss_lg_t_crook_ammo_special", // Unique name used in server overrides and in the terminal (default).  Should be different for each ammoDef used by the same weapon.  Referred to for Shrapnel.
            ...
            BaseDamageCutoff = 0,  // Maximum amount of pen damage to apply per block hit.  Deducts from BaseDamage and uses DamageScales modifiers
                                   ...
                                   // Overwrites normal damage behavior of requiring a block to be destroyed before damage can continue.  0 disables. 
                                   // To limit max # of blocks hit, set MaxObjectsHit to desired # and ensure CountBlocks = true in ObjectsHit, otherwise it will continue until BaseDamage depletes
            Mass = 25, // In kilograms; how much force the impact will apply to the target, multiplied by projectile speed at time of impact (beams only use the Mass value specified, no multiplier)
            ...
            BackKickForce = 30f * CANNON_VELOCITY, // Recoil. This is applied to the Parent Grid.
            DecayPerShot = 0f, // Damage to the firing weapon itself. 
                               //float.MaxValue will drop the weapon to the first build state and destroy all components used for construction
                               //If greater than cube integrity it will remove the cube upon firing, without causing deformation (makes it look like the whole "block" flew away)
            HardPointUsable = true, // Whether this is a primary ammo type fired directly by the turret. Set to false if this is a shrapnel ammoType and you don't want the turret to be able to select it directly.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 900, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
                AccelPerSec = 0f, // Acceleration in Meters Per Second. Projectile starts on tick 0 at its parents (weapon/other projectiles) travel velocity.
                DesiredSpeed = CANNON_VELOCITY, // voxel phasing if you go above 5100
                MaxTrajectory = CLOSE_RANGE, // Max Distance the projectile or beam can Travel.
                DeaccelTime = 0, // EWAR & Mines only- time to spend slowing down to stop at end of trajectory.  0 is instant stop
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
