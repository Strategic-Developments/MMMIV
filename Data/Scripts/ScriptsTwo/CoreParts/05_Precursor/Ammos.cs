...
namespace Scripts
{
    partial class Parts
    {
        private AmmoDef Tetryon => new AmmoDef //Longest range, lowest dmg.
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Tetryon",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 50,
                        Color = Color(red: 70, green: 20, blue: 15, alpha: 1f),
                        Back = true,
                        CustomWidth = 0,
        ...
        private AmmoDef Mystic => new AmmoDef //Longest range, lowest dmg.
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Mystic",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
        ...
        private AmmoDef Occult => new AmmoDef //Longest range, lowest dmg.
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Occult",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
