    ...
    partial class Parts
    {
        WeaponDefinition mss_lg_t_entropicdisintegrator => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "mss_lg_t_entropic", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            HardPoint = new HardPointDef
            {
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "EntropicFire", // SubtypeId of muzzle particle effect.
