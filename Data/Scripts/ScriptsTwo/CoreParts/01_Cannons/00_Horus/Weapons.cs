...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition mss_lg_t_horus => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "mss_lg_t_horus_base", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Horus-Pattern Artillery Battery", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 1520 * 2.01f / 1000f, // Inventory capacity in kL.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "shell_out_med_02", // Audio for firing.
