...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition mss_lg_t_sekhmet => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "mss_lg_t_sekhmet_base", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "ELE1", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "AZ1", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "ELE1",// Your Elevating Subpart, that bit that moves up.
            ...
            {
                PartName = "Sekhmet-Pattern Artillery Battery", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 1330 * 4.01f / 1000f, // Inventory capacity in kL.
                ...
                {
                    RateOfFire = 180, // Set this to 3600 for beam weapons. This is how fast your gun fires per minute.
            ...
            Ammos = new[] {
                mss_lg_t_sekhmet_ammo,
                mss_lg_t_sekhmet_ammo_special
            },
