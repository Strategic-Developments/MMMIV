...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef mss_lg_t_sekhmet_ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            Mass = 450, // In kilograms; how much force the impact will apply to the target, multiplied by projectile speed at time of impact (beams only use the Mass value specified, no multiplier)
            ...
            BackKickForce = 607.5f * CANNON_VELOCITY, // Recoil. This is applied to the Parent Grid.
