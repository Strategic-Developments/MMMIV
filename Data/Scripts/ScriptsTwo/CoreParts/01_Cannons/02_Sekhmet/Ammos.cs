...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef mss_lg_t_sekhmet_ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "mss_lg_t_sekhmet_ammomagazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "mss_lg_t_sekhmet_ammo", // Unique name used in server overrides and in the terminal (default).  Should be different for each ammoDef used by the same weapon.  Referred to for Shrapnel.
            ...
            Mass = 1250, // In kilograms; how much force the impact will apply to the target, multiplied by projectile speed at time of impact (beams only use the Mass value specified, no multiplier)
            ...
            BackKickForce = 1687.5f * CANNON_VELOCITY, // Recoil. This is applied to the Parent Grid.
        ...
        private AmmoDef mss_lg_t_sekhmet_ammo_special => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "mss_lg_t_sekhmet_ammomagazine_special", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "mss_lg_t_sekhmet_ammo_special", // Unique name used in server overrides and in the terminal (default).  Should be different for each ammoDef used by the same weapon.  Referred to for Shrapnel.
            TerminalName = "Smart", // Optional terminal name for this ammo type, used when picking ammo/cycling consumables.  Safe to have duplicates across different ammo defs.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 75, // Modified in MasterConfig here, actually just the power requirement needed to fire at 1.0 ROF scalar  If patterning ammos, only the main ammo (first fired) will count toward energy.
            BaseDamage = 1, // Direct damage; one steel plate is worth 100.
            BaseDamageCutoff = 0,  // Maximum amount of pen damage to apply per block hit.  Deducts from BaseDamage and uses DamageScales modifiers
