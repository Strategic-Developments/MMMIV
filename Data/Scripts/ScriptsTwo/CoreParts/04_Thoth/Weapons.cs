...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition mss_lg_t_thoth => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "mss_lg_t_thoth_base", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Thoth-Pattern Jump Disruptor", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RotateRate = MEDIUM_ROTATE_SPEED, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = MEDIUM_ROTATE_SPEED, // Max traversal speed of elevation subpart in radians per tick.
                    ...
                    IdlePower = 50, // Constant base power draw in MW.
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 3 * 60, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 1, // Number of physical magazines to consume on reload.
                    DelayUntilFire = 0, // How long the weapon waits before shooting after being told to fire. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    HeatPerShot = (int)(300000f / 120f), // Heat generated per shot (BarrelsPerShot * HeatPerShot is the total heat per firing event).
                    MaxHeat = 300000, // Max heat before weapon enters cooldown (70% of max heat).
