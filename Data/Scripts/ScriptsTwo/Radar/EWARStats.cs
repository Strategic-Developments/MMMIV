...
namespace SRRadarStats
{
    ...
    public class EWARStats : MySessionComponentBase
    {
        BlockConfig cfg => new BlockConfig()
        {
            RadarStats = new Dictionary<string, RadarStat>()
            {
                ["Nerd_Radar"] = new RadarStat()
                {
                    ...
                    MaxSearchRange = 1000000, // maximum range radar will return targets, regardless of other settings, in meters
            ...
            UpgradeBlockStats = new Dictionary<string, UpgradeBlockStat>()
            {
                ...
                ["ARYLYNX_SILVERSMITH_DRIVE"] = new UpgradeBlockStat()
                {
                    ...
                    RCSMultiplier = 1.65f, // RCS multiplier for the grid this is mounted on. Multipliers are calculated BEFORE addons.
                ...
                ["ARYLNX_SCIRCOCCO_Epstein_Drive"] = new UpgradeBlockStat()
                {
                    ...
                    RCSMultiplier = 3.3f, // RCS multiplier for the grid this is mounted on. Multipliers are calculated BEFORE addons.
                    RCSAddon = 0, //  RCS addon for the grid this is mounted on. Addons are calculated AFTER multipliers.
                ...
                ["ARYLNX_Mega_Epstein_Drive"] = new UpgradeBlockStat()
                {
                    ...
                    RCSMultiplier = 4.5f, // RCS multiplier for the grid this is mounted on. Multipliers are calculated BEFORE addons.
                    RCSAddon = 0, //  RCS addon for the grid this is mounted on. Addons are calculated AFTER multipliers.
                ...
                ["mss_lg_beamdrill"] = new UpgradeBlockStat()
                {
                    DefinitionPriority = 1,
                    // these two are incompatible with eachother.
                    ApplyOnlyWhenFiring = false, // WEAPON BLOCKS ONLY. Makes all of the addons/multipliers apply only when the weapon is firing.
                    ...
                    RCSMultiplier = 100f, // RCS multiplier for the grid this is mounted on. Multipliers are calculated BEFORE addons.
                    RCSAddon = 0, //  RCS addon for the grid this is mounted on. Addons are calculated AFTER multipliers.
                ...
                ["LG_Simple_Laser_Multitool"] = new UpgradeBlockStat()
                {
                    DefinitionPriority = 1,
                    // these two are incompatible with eachother.
                    ApplyOnlyWhenFiring = false, // WEAPON BLOCKS ONLY. Makes all of the addons/multipliers apply only when the weapon is firing.
                ...
                ["LG_Simple_Laser_Multitool_Turret"] = new UpgradeBlockStat()
                {
                    DefinitionPriority = 1,
                    // these two are incompatible with eachother.
                    ApplyOnlyWhenFiring = false, // WEAPON BLOCKS ONLY. Makes all of the addons/multipliers apply only when the weapon is firing.
                ...
                ["mss_mk1_salvager"] = new UpgradeBlockStat()
                {
                    DefinitionPriority = 1,
                    // these two are incompatible with eachother.
                    ApplyOnlyWhenFiring = false, // WEAPON BLOCKS ONLY. Makes all of the addons/multipliers apply only when the weapon is firing.
                ...
                ["mss_mk2_salvager"] = new UpgradeBlockStat()
                {
                    DefinitionPriority = 1,
                    // these two are incompatible with eachother.
                    ApplyOnlyWhenFiring = false, // WEAPON BLOCKS ONLY. Makes all of the addons/multipliers apply only when the weapon is firing.
                ...
                ["SG_Simple_Laser_Multitool"] = new UpgradeBlockStat()
                {
                    DefinitionPriority = 1,
                    // these two are incompatible with eachother.
                    ApplyOnlyWhenFiring = false, // WEAPON BLOCKS ONLY. Makes all of the addons/multipliers apply only when the weapon is firing.
                    ...
                    RCSMultiplier = 500f, // RCS multiplier for the grid this is mounted on. Multipliers are calculated BEFORE addons.
                    RCSAddon = 0, //  RCS addon for the grid this is mounted on. Addons are calculated AFTER multipliers.
        ...
        static UpgradeBlockStat DRIVE_3x3 = new UpgradeBlockStat()
        {
            ...
            RCSMultiplier = 1.5f, // RCS multiplier for the grid this is mounted on. Multipliers are calculated BEFORE addons.
            RCSAddon = 0, //  RCS addon for the grid this is mounted on. Addons are calculated AFTER multipliers.
